...
class NPuzzleSolverGraphS:
    def __init__(self, size=4, goal_state=None, model_path='/kaggle/input/final_ann/keras/default/1/keras-1024-1024-512-128-64-amse04.h5'):
        self.size = size
        self.n = size * size
    ...
    def heuristic(self, state):
        ...
        x_encoded = np.eye(16)[flat_state].reshape(-1)
        output = self.model.predict(x_encoded.reshape(1, -1), verbose=0)
        return max(output.item(), 0)
    ...
    def solve(self, start_state):
        ...
        pq = []
        visited = set()
        heapq.heappush(pq, (self.heuristic(start_state), 0, start_state, []))
        ...
        while pq:
            ...
            for neighbor in self.get_neighbors(current):
                neighbor_key = self.state_to_tuple(neighbor)
...
class NumberNPuzzle(QMainWindow):
    ...
    def initUI(self):      
        ...
        self.resize(1330, 963)  # Increased width to accommodate two columns
        ...
        # Left column buttons (BFS, IDS, Greedy, A* variants)
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(730, 320, 281, 31))
        self.pushButton_7.setFont(font)
        self.pushButton_7.setObjectName("pushButton_7")

        self.pushButton_8 = QtWidgets.QPushButton(self)
        self.pushButton_8.setGeometry(QtCore.QRect(730, 410, 281, 31))
        self.pushButton_8.setFont(font)
        self.pushButton_8.setObjectName("pushButton_8")

        self.pushButton_9 = QtWidgets.QPushButton(self)
        self.pushButton_9.setGeometry(QtCore.QRect(730, 500, 281, 31))
        self.pushButton_9.setFont(font)
        self.pushButton_9.setObjectName("pushButton_9")

        self.pushButton_10 = QtWidgets.QPushButton(self)
        self.pushButton_10.setGeometry(QtCore.QRect(730, 590, 281, 31))
        self.pushButton_10.setFont(font)
        self.pushButton_10.setObjectName("pushButton_10")

        self.pushButton_11 = QtWidgets.QPushButton(self)
        self.pushButton_11.setGeometry(QtCore.QRect(730, 680, 281, 31))
        self.pushButton_11.setFont(font)
        self.pushButton_11.setObjectName("pushButton_11")

        # Right column buttons (ANN-GraphSearch0.4, ANN-TreeSearch0.4, ANN-TreeSearch0.8)
        self.pushButton_4 = QtWidgets.QPushButton(self)
        self.pushButton_4.setGeometry(QtCore.QRect(1030, 50, 281, 31))
        self.pushButton_4.setFont(font)
        self.pushButton_4.setObjectName("pushButton_4")

        self.pushButton_5 = QtWidgets.QPushButton(self)
        self.pushButton_5.setGeometry(QtCore.QRect(1030, 140, 281, 31))
        self.pushButton_5.setFont(font)
        self.pushButton_5.setObjectName("pushButton_5")

        self.pushButton_6 = QtWidgets.QPushButton(self)
        self.pushButton_6.setGeometry(QtCore.QRect(1030, 230, 281, 31))
        ...
        # Left column labels (BFS, IDS, Greedy, A* variants)
        ...
        self.time_7.setGeometry(QtCore.QRect(730, 360, 201, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.num_of_steps_7.setGeometry(QtCore.QRect(730, 380, 201, 16))
        ...
        self.time_value_7.setGeometry(QtCore.QRect(870, 360, 201, 16))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.num_of_steps_value_7.setGeometry(QtCore.QRect(870, 380, 201, 16))
        ...
        self.time_8.setGeometry(QtCore.QRect(730, 450, 201, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.num_of_steps_8.setGeometry(QtCore.QRect(730, 470, 201, 16))
        ...
        self.time_value_8.setGeometry(QtCore.QRect(870, 450, 201, 16))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.num_of_steps_value_8.setGeometry(QtCore.QRect(870, 470, 201, 16))
        ...
        self.time_9.setGeometry(QtCore.QRect(730, 540, 201, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.num_of_steps_9.setGeometry(QtCore.QRect(730, 560, 201, 16))
        ...
        self.time_value_9.setGeometry(QtCore.QRect(870, 540, 201, 16))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.num_of_steps_value_9.setGeometry(QtCore.QRect(870, 560, 201, 16))
        ...
        self.time_10.setGeometry(QtCore.QRect(730, 630, 201, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.num_of_steps_10.setGeometry(QtCore.QRect(730, 650, 201, 16))
        ...
        self.time_value_10.setGeometry(QtCore.QRect(870, 630, 201, 16))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.num_of_steps_value_10.setGeometry(QtCore.QRect(870, 650, 201, 16))
        ...
        # Right column labels (ANN-GraphSearch0.4, ANN-TreeSearch0.4, ANN-TreeSearch0.8)
        self.time_4 = QtWidgets.QLabel(self)
        self.time_4.setGeometry(QtCore.QRect(1030, 90, 201, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.num_of_steps_4.setGeometry(QtCore.QRect(1030, 110, 201, 16))
        ...
        self.time_value_4.setGeometry(QtCore.QRect(1170, 90, 201, 16))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.num_of_steps_value_4.setGeometry(QtCore.QRect(1170, 110, 201, 16))
        ...
        self.time_5.setGeometry(QtCore.QRect(1030, 180, 201, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.num_of_steps_5.setGeometry(QtCore.QRect(1030, 200, 201, 16))
        ...
        self.time_value_5.setGeometry(QtCore.QRect(1170, 180, 201, 16))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.num_of_steps_value_5.setGeometry(QtCore.QRect(1170, 200, 201, 16))
        ...
        self.line_33.setGeometry(QtCore.QRect(1030, 170, 281, 16))
        ...
        self.line_34.setGeometry(QtCore.QRect(1030, 211, 281, 16))
        ...
        self.line_35.setGeometry(QtCore.QRect(1030, 178, 3, 40))
        ...
        self.line_36.setGeometry(QtCore.QRect(1310, 180, 3, 40))
        ...
        self.time_6.setGeometry(QtCore.QRect(1030, 270, 201, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.num_of_steps_6.setGeometry(QtCore.QRect(1030, 290, 201, 16))
        ...
        self.time_value_6.setGeometry(QtCore.QRect(1170, 270, 201, 16))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.num_of_steps_value_6.setGeometry(QtCore.QRect(1170, 290, 201, 16))
        ...
        self.line_37.setGeometry(QtCore.QRect(1030, 260, 281, 16))
        ...
        self.line_38.setGeometry(QtCore.QRect(1030, 301, 281, 16))
        ...
        self.line_39.setGeometry(QtCore.QRect(1030, 268, 3, 40))
        ...
        self.line_40.setGeometry(QtCore.QRect(1310, 270, 3, 40))
        ...
        # Remove unused lines (previously for pushButton_11 and related labels)

        self.time_11 = QtWidgets.QLabel(self)
        self.time_11.setGeometry(QtCore.QRect(730, 720, 201, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.time_11.setFont(font)
        self.time_11.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.time_11.setWordWrap(True)
        self.time_11.setObjectName("time_11")
        self.num_of_steps_11 = QtWidgets.QLabel(self)
        self.num_of_steps_11.setGeometry(QtCore.QRect(730, 740, 201, 16))
        self.num_of_steps_11.setFont(font)
        self.num_of_steps_11.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.num_of_steps_11.setWordWrap(True)
        self.num_of_steps_11.setObjectName("num_of_steps_11")
        self.time_value_11 = QtWidgets.QLabel(self)
        self.time_value_11.setGeometry(QtCore.QRect(870, 720, 201, 16))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.time_value_11.setFont(font)
        self.time_value_11.setText("")
        self.time_value_11.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.time_value_11.setWordWrap(True)
        self.time_value_11.setObjectName("time_value_11")
        self.num_of_steps_value_11 = QtWidgets.QLabel(self)
        self.num_of_steps_value_11.setGeometry(QtCore.QRect(870, 740, 201, 16))
        self.num_of_steps_value_11.setFont(font)
        self.num_of_steps_value_11.setText("")
        self.num_of_steps_value_11.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.num_of_steps_value_11.setWordWrap(True)
        self.num_of_steps_value_11.setObjectName("num_of_steps_value_11")

        self.line_41 = QtWidgets.QFrame(self)
        self.line_41.setGeometry(QtCore.QRect(730, 718, 3, 40))
        ...
        self.line_42 = QtWidgets.QFrame(self)
        self.line_42.setGeometry(QtCore.QRect(1010, 720, 3, 40))
        ...
        self.line_43 = QtWidgets.QFrame(self)
        self.line_43.setGeometry(QtCore.QRect(730, 710, 281, 16))
        ...
        self.line_44 = QtWidgets.QFrame(self)
        self.line_44.setGeometry(QtCore.QRect(730, 751, 281, 16))
    ...
    def retranslateUi(self, Form):
        ...
        def GreedyLC():
            ...
            a = str(round(time, 5))
            self.time_value_11.setText(_translate("Form", str(a)))
            b = str(num_steps)
            self.num_of_steps_value_11.setText(_translate("Form", b))
            self.way = path
            if path:
                self.simulatePath(path)

        def ANNGraphSearch04():
            if self.num_row != 4:
                QMessageBox.warning(self, "Invalid Puzzle Size", "The ANN-GraphSearch0.4 solver only supports 4x4 puzzles. Please select 4 rows in the combo box.")
                self.time_value_4.setText(_translate("Form", "N/A"))
                self.num_of_steps_value_4.setText(_translate("Form", "N/A"))
                self.way = []
                return
            try:
                solver = NPuzzleSolverGraphS(size=self.num_row, model_path='C:/Users/DUYEN/OneDrive/Documents/GitHub/NhapmonAI-Project/model/ann.h5')
                ...
                if time is None or num_steps is None:
                    print("ANN-GraphSearch0.4: No solution found")
                    self.time_value_4.setText(_translate("Form", "N/A"))
                    self.num_of_steps_value_4.setText(_translate("Form", "N/A"))
                    self.way = []
                else:
                    print(f"ANN-GraphSearch0.4: num_steps={num_steps}, path_length={len(path)}, path={path}")
                    a = str(round(time, 5))
        ...
        def ANNTreeSearch04():
            if self.num_row != 4:
                QMessageBox.warning(self, "Invalid Puzzle Size", "The ANN-TreeSearch0.4 solver only supports 4x4 puzzles. Please select 4 rows in the combo box.")
                self.time_value_5.setText(_translate("Form", "N/A"))
                self.num_of_steps_value_5.setText(_translate("Form", "N/A"))
                self.way = []
                return
            try:
                solver = NPuzzleSolverTreeS(size=self.num_row, model_path='C:/Users/DUYEN/OneDrive/Documents/GitHub/NhapmonAI-Project/model/tree-04.h5')
                time, num_steps, path = solver.solve(self.blocks)
                ...
                if time is None or num_steps is None:
                    print("ANN-TreeSearch0.4: No solution found")
                    self.time_value_5.setText(_translate("Form", "N/A"))
                    self.num_of_steps_value_5.setText(_translate("Form", "N/A"))
                    self.way = []
                else:
                    print(f"ANN-TreeSearch0.4: num_steps={num_steps}, path_length={len(path)}, path={path}")
                    a = str(round(time, 5))
        ...
        def ANNTreeSearch08():
            if self.num_row != 4:
                QMessageBox.warning(self, "Invalid Puzzle Size", "The ANN-TreeSearch0.8 solver only supports 4x4 puzzles. Please select 4 rows in the combo box.")
                self.time_value_6.setText(_translate("Form", "N/A"))
                self.num_of_steps_value_6.setText(_translate("Form", "N/A"))
                self.way = []
                return
            try:
                solver = NPuzzleSolverTreeS(size=self.num_row, model_path='C:/Users/DUYEN/OneDrive/Documents/GitHub/NhapmonAI-Project/model/tree-08.h5')
                time, num_steps, path = solver.solve(self.blocks)
                ...
                if time is None or num_steps is None:
                    print("ANN-TreeSearch0.8: No solution found")
                    self.time_value_6.setText(_translate("Form", "N/A"))
                    self.num_of_steps_value_6.setText(_translate("Form", "N/A"))
                    self.way = []
                else:
                    print(f"ANN-TreeSearch0.8: num_steps={num_steps}, path_length={len(path)}, path={path}")
                    a = str(round(time, 5))
        ...
        self.pushButton_4.setText(_translate("Form", "ANN-GraphSearch0.4"))
        self.pushButton_4.clicked.connect(ANNGraphSearch04)
        self.pushButton_5.setText(_translate("Form", "ANN-TreeSearch0.4"))
        self.pushButton_5.clicked.connect(ANNTreeSearch04)
        self.pushButton_6.setText(_translate("Form", "ANN-TreeSearch0.8"))
        self.pushButton_6.clicked.connect(ANNTreeSearch08)
        self.pushButton_7.setText(_translate("Form", "A* (Misplaced Tiles)"))
        self.pushButton_7.clicked.connect(AStarMT)
        self.pushButton_8.setText(_translate("Form", "A* (Manhattan)"))
        self.pushButton_8.clicked.connect(AStarMHT)
        self.pushButton_9.setText(_translate("Form", "A* (Weighted Manhattan)"))
        self.pushButton_9.clicked.connect(AStarWMHT)
        self.pushButton_10.setText(_translate("Form", "A* (Linear Conflict)"))
        self.pushButton_10.clicked.connect(AStarLC)
        self.pushButton_11.setText(_translate("Form", "Greedy (Linear Conflict)"))
        self.pushButton_11.clicked.connect(GreedyLC)
        ...
        self.num_of_steps_11.setText(_translate("Form", "  Number of steps: "))
        self.time_11.setText(_translate("Form", "  Time: "))
